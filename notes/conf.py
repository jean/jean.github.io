...
BLOG_AUTHOR = "Author"  # (translatable)
BLOG_TITLE = "Notes in Passing"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jean.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://jean.github.io/"
BLOG_EMAIL = "jean.jordaan+notes@gmail.com"
BLOG_DESCRIPTION = "Occasional Notes"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "occasionalnotes"
